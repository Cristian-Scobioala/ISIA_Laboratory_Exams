CREATE TABLE `employee_exam_12_2022_8xxxxxx` (
  `afm` varchar(45) NOT NULL,
  `firstname` varchar(45) NOT NULL,
  `lastname` varchar(45) NOT NULL,
  `salary` double NOT NULL,
  `external_partner` TINYINT(1) NOT NULL,
  PRIMARY KEY (`afm`)
...
INSERT INTO `employee_exam_12_2022_8xxxxxx` (`afm`,`firstname`,`lastname`,`salary`,`external_partner`) VALUES ('222222222','Rita','Jewer',1640, 1);
INSERT INTO `employee_exam_12_2022_8xxxxxx` (`afm`,`firstname`,`lastname`,`salary`,`external_partner`) VALUES ('333333333','Alan','Lancastle',940, 1);